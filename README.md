...
The **Atlas** is a tool that allows users to quickly compose a visual narrative about countries and the products they exchange. It is originally the master's thesis work of Alexander Simoes.

### Data

The observatory provides access to bilateral trade data for roughly 200 countries, 50 years and 1000 different products of the SITC4 revision 2 classification and HS4 classification. The source of the data we are using is:
